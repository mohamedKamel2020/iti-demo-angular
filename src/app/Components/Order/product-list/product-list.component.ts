...
export class ProductListComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(): void {
    ...
    this.prdListOFCategory=this.staticProductService.getProductsByCategoryId(this.sentCategoryId);
  }
  ngOnInit(): void {
    this.prdListOFCategory=this.staticProductService.getAllProducts();
